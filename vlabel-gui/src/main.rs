...
/// VLabel - Image Annotation Tool
#[derive(Parser, Debug)]
#[command(name = "vlabel-gui")]
#[command(author = "VLabel Contributors")]
...
fn main() -> Result<(), eframe::Error> {
    ...
    log::info!("Starting VLabel v{}", env!("CARGO_PKG_VERSION"));

    let options = eframe::NativeOptions {
        viewport: egui::ViewportBuilder::default()
            .with_inner_size([1280.0, 800.0])
            .with_title("VLabel - Image Annotation Tool"),
        ..Default::default()
    };
