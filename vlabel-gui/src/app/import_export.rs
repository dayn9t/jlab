    ...
    fn try_import_dataset(&mut self, format: DatasetFormat) -> anyhow::Result<()> {
        ...
        let imported = match format {
            DatasetFormat::Yolo => {
                ...
                vlabel_utils::import::import_from_yolo(&root, &meta)?
            }
            DatasetFormat::Voc => {
                let Some(root) =
                ...
                vlabel_utils::import::import_from_voc(&root, &meta)?
            }
            DatasetFormat::Coco => {
                ...
                vlabel_utils::import::import_from_coco(&json_path, &images_dir, &meta)?
            }
            DatasetFormat::LabelMe => {
                ...
                vlabel_utils::import::import_from_labelme(&root, &meta)?
            }
        };

        vlabel_utils::import::merge_imported_images(
            imported,
            project,
            &existing_names,
            &duplicate_template,
